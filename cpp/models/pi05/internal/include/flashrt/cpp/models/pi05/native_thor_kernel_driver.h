#ifndef FLASHRT_CPP_MODELS_PI05_NATIVE_THOR_KERNEL_DRIVER_H
#define FLASHRT_CPP_MODELS_PI05_NATIVE_THOR_KERNEL_DRIVER_H
...
enum class NativeThorFp8Tactic {
    kSquare,
    kT1,
    kWide,
    kPlain,
...
class NativeThorKernelDriver {
public:
    NativeThorKernelDriver() noexcept;
    ~NativeThorKernelDriver();

    NativeThorKernelDriver(const NativeThorKernelDriver&) = delete;
    NativeThorKernelDriver& operator=(const NativeThorKernelDriver&) = delete;
...
#endif  // FLASHRT_CPP_MODELS_PI05_NATIVE_THOR_KERNEL_DRIVER_H
