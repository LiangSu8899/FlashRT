...
| TTFA | **~94 ms** | **~127 ms** | 0.36-0.63 s |
| Per-frame | **~3.2 ms** | **~6.0 ms** | ~6.4 ms |
...
BF16 prefill-only latency improves from **8.42 → 6.79 ms** at P=6 and
**11.74 → 6.86 ms** at P=13 in the same single-stream frontend benchmark.
